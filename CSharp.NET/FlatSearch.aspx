<%@ Page language="c#" Inherits="com.qas.prowebintegration.FlatSearch" enableViewState="False" CodeFile="FlatSearch.aspx.cs" %>
...
<HTML>
	...
	<body>
					...
					<td class="nomargin">
						...
						<table>
							...
							<tr>
								...
								<td width="15"></td>
								<td>
									<%= HttpUtility.HtmlEncode(atItems[i].Postcode) %>
								</td>
							</tr>
							<%
							}%>
		...
		<form name="PrivateData">
			...
			for (int i=0; i < atItems.Length; i++)
			{
				RenderHiddenField(FIELD_MUST_REFINE, MustRefine(atItems[i]));
			}
			%>
		</form>
	</body>
