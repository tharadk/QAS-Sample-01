<%@ Page language="c#" Inherits="com.qas.prowebintegration.FlatCountry" enableViewState="False" CodeFile="FlatCountry.aspx.cs" %>
			...
			<table width="800" class="nomargin">
				...
				<tr>
					<td class="nomargin">
						...
						Please select a country or datamap from the list below.<br /><br />
