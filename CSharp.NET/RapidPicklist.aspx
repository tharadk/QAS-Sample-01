<%@ Page language="c#" Inherits="com.qas.prowebintegration.RapidPicklist" enableViewState="False" EnableEventValidation="false" CodeFile="RapidPicklist.aspx.cs" %>
...
%>				// Pick up picklist HTML from the appropriate source
			...
			function refine(sDataID, sMoniker, iDepth, sSearchText)
			{
				...
				<%= GetPostBackEventReference(ActionUpdate) %>;
			}
		</script>
	</HEAD>
	<body onload="init();">
